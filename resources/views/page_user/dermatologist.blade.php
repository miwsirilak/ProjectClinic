            ...
            <div class="card-body">
                ...
                <div class="card mb-3" style="max-width: 1000px;">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="{{ asset('img/doctor.jpg') }}" class="card-img" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <a href="{{ route('location') }}" class="fas fa-map-marker-alt btn-danger btn-lg disabled"
                                    role="button" aria-disabled="true">Google Map</a>
                                <br><br>
                                <img src="{{ asset('img/logodoctor.jpg') }}" class="card-img" alt="...">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <img src="{{ asset('img/line3.jpg') }}" class="card-img" alt="..." height="330" width="320">
                        </div>
                    </div>
                </div> --}}
