              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                      <i class="fas fa-arrow-circle-right fa-2x text-rgb-300" style="color:rgb(18, 134, 67);"></i>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                      <i class="fas fa-window-close fa-2x text-rgb-300" style="color:rgb(18, 134, 67);"></i>
                    </div>
                  </div>
                </div>
              </div>
