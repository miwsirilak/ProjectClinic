              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    ...
                    <div class="h6 mb-0 font-weight-bold text-gray-800">ตารางการทำงานของแพทย์</div>
                  </div>
                  <div class="col-auto">
                    <i class="fas fa-calendar fa-2x text-rgb-300" style="color:rgb(241, 147, 183);"></i>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      ...
                      <div class="col-auto">
                        <i class="fas fa-user-lock fa-2x text-rgb-300" style="color:rgb(241, 147, 183);"></i>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card border-left-success shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      ...
                      <div class="col-auto">
                        <i class="fas fa-address-book fa-2x text-rgb-300" style="color:rgb(241, 147, 183);"></i>
                      </div>
                    </div>
                  </div>
                </div>
