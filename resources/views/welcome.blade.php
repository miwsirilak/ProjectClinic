    ...
    <div id="wrapper">
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#27a7e2;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                <img src="{{ asset('img/logoclinic.png') }}" class="img-circle" alt="Cinque Terre" width="120"
                    height="120">
                ...
                <div class="container mt-2">
                    ...
                    @foreach ($posts as $post)
                        <div class="card border-success">
                            <div class="card-header h6 mb-0 font-weight-bold text-gray-800">ข่าวสาร</div>
                            <div class="card-body">
                                                ...
                                                @if (Auth::user()->role === 'admin')
                                                    <form action="{{ route('posts.destroy', $post->id) }}" method="POST">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('posts.edit', $post->id) }}">แก้ไขข่าวสาร</a>
                                                        @csrf
                                                        @method('DELETE')

                                                        <button type="submit" class="btn btn-danger"
                                                            onclick="return confirm('ท่านต้องการลบความรู้ข่าวสารหรือไม่ ?')">ลบข่าวสาร</button>
